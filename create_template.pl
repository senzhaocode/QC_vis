...
use HIGHTPLOT;
	...
	push @usage, "	--control	If users would like to show a subset of all samples, please use this option for sample control [sample names separated by coma, e.g. name1, name2, name2], \n\t\t\tand user can list sample names used for controlling in a file\n";
	push @usage, "	--template	HTML template path (including css and javascript files)\n";
	push @usage, "	--output	Output file name [html format]\n";
